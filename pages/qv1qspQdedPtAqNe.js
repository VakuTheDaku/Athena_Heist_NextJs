    ...
    return(
        <div className="min-h-screen bg-indigo-400">
            ...
            <form onSubmit={onSubmit} className="bg-transparent text-white">
                <div className="label flex items-center justify-center">Model or Princeton architecture — is a computer architecture based on a 1945 </div>
